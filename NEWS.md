...
* Fixed `tidyselect` deprecation warnings for external vector selections in `siteAdjustment` and `siteAdjustmentFactors`

* Added documentation header for re-exported functions

* Corrected year of paper reference in DESCRIPTION
